...
炎炎夏日，位于联邦东部的池云雨林，云雾弥漫，好似一层薄纱环绕，一棵棵参天古树，纵横交错，繁茂的树冠中，时而有几只飞鸟腾空而起，嘶鸣着翱翔于天际间。 
    ...
    “所有人，立刻于修灵室报道，穿上你们的磁灵服，半柱香后，我们将进入雷磁区！” 

    话语一出，食馆的众学子纷纷敬畏，赶紧站好。 

    王宝乐眼睛一亮，眼前这老者，正是他之前送过礼的卢医师，此刻望着对方那龙行虎步般的气势，王宝乐越发觉得自己之前的投资没错，暗道这老家伙必非常人，而自己更是棋高一手。 

    正美滋滋的得意时，那老医师目光一扫，看到了王宝乐，哼了一声，走了过来，从怀里拿出半块黑色的面具，扔在了王宝乐身上。 
    ...
    于是深吸口气，赶紧摆出一副悔悟的模样，承认错误。 

    “老师说的对，我错了！” 

    老医师有些诧异，原本要训斥的话语，因对方如此痛快的认错，有些说不下去了。 

    王宝乐看到老医师的表情，松了口气，又有一些得意，暗道这高官自传，的确有用啊。 

    老医师哼了一声，抬头扫向整个食馆所有学子，右手一指众人。 
    ...
    随着警报声的加剧，众人这才结束了议论，一个个心底愤愤的去了修灵室。 
    ...
    “晦气！”二人都心底嘀咕，赶紧避开目光，仿佛就连彼此看一眼，都觉得辣眼睛。 
...
db = DBhelper()
# db.update("insert into chapter (novelId,chapterId,title,content) value (%s,%s,%s,%s)",
#           (1, 1, "aaa", zlib_s))
value = db.query_one("SELECT content FROM `chapter`")

b1 = zlib.decompress(value[0])
print(len(b1))
print(b1.decode("GBK"))
...
#         sql = "SELECT content FROM `chapter`"
#         cursor.execute(sql)
